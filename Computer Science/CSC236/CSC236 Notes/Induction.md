...
> There are two versions of induction, [[Simple Induction|Simple/Weak Induction]], and [[Complete Induction|Complete/Strong Induction]]

---
## Simple Induction

[[Simple Induction]] is when you prove  that$(P(0)\wedge \forall k \in \mathbb{N})\implies P(k+1))\implies \forall n\in \mathbb{N},P(n)$ 
...
>  One use case of **Complete Induction** is proving that for every element of the [[Fibonacci Sequence]], $f_{n}=\frac{(\frac{1+\sqrt{5}}{2})n-(\frac{1-\sqrt{5}}{2})n}{\sqrt{5}}$ 
...
[[Structural Induction]] is a proving technique very similar to [[Induction]] (Hence the name)
