...
int main(int argc, char **argv) {
    ...
    /* We are actually creating the following array to be one larger than 
     * we need. However this means that the index of argv and the index of 
     * pipe_fd will be the same for each child.
     */
