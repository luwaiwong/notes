...
### Probability Distributions
[Probability Distributions](../../STA238/STA238%20Notes/Probability%20Distribution.md) help describe different types of experiments, and help us graph and model the probability of experiments
...
A [Discrete Random Variable](Discrete%20Random%20Variable.md) describes the probability that events that can be described with discrete numbers, such as rolling a number on a dice. But [Continuous Random Variable](Continuous%20Random%20Variable.md)s describe experiments that can be described on a **continuous scale**. 
	...
	The [Cumulative Distribution Function](Cumulative%20Distribution%20Function.md) is the [Integral](../../MAT235/Notes/Integral.md) of the [Probability Mass Function](Probability%20Mass%20Function.md)
...
The [Expected Value](Expected%20Value.md) is the mean of all the probability of a [Random Variable](../../STA238/STA238%20Notes/Random%20Variable.md)

The [Variance](Variance.md) of a [Random Variable](../../STA238/STA238%20Notes/Random%20Variable.md) describes the spread around the mean of a random variable
...
### Joint Distribution
The [Joint Distribution](Joint%20Distribution.md) of two or more [Random Variable](../../STA238/STA238%20Notes/Random%20Variable.md)s describes the probability distributions of those *random variables* having the same value
...
The [Marginal Probability Mass Function](Marginal%20Probability%20Mass%20Function.md) describes the probability of one of the [Random Variable](../../STA238/STA238%20Notes/Random%20Variable.md)s in a [Joint Distribution](Joint%20Distribution.md) occurring
...
The equations of [Joint Distribution](Joint%20Distribution.md)s for Discrete Random Variables and Continuous Random Variables are very similar in idea, but continuous random variables use [Integral](../../MAT235/Notes/Integral.md)s to sum the [Probability Density Function](Probability%20Density%20Function.md)
...
### Independence
Two [Random Variable](../../STA238/STA238%20Notes/Random%20Variable.md)s $X$ and $Y$ are [Independent](Independence.md) if the probability of one does not influence the other
...
The [Covariance](Covariance.md) of two [Random Variable](../../STA238/STA238%20Notes/Random%20Variable.md)s is a measure of their *joint variability*, or their *degree of association*
...
The [Correlation Coefficient](Correlation%20Coefficient.md) describes the correlation between two [Random Variable](../../STA238/STA238%20Notes/Random%20Variable.md)s
