...
---
# Definition
Two [Random Variable](../../STA238/STA238%20Notes/Random%20Variable.md)s $X$ and $Y$ have a **Joint Continuous Distribution** if for some [Function](../../MAT235/Notes/Function.md) $f:\mathbb{R}^{2}\rightarrow \mathbb{R}$ and for all numbers $a_{1},a_{2}$ and $b_{1},b_{2}$ with $a_{1}\leq b_{1}$ and $a_{2}\leq b_{2}$,
